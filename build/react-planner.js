...
class ReactPlanner extends Component {
    getChildContext() {
        return Object.assign(Object.assign({}, objectsMap(actions, actionNamespace => this.props[actionNamespace])), { translator: this.props.translator, catalog: this.props.catalog });
    }
    componentWillMount() {
    ...
    render() {
        let _a = this.props, { width, height, state, stateExtractor } = _a, props = __rest(_a, ["width", "height", "state", "stateExtractor"]);
...
ReactPlanner.childContextTypes = Object.assign(Object.assign({}, objectsMap(actions, () => PropTypes.object)), { translator: PropTypes.object, catalog: PropTypes.object });
