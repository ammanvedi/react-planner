...
const toggleButtonStyleOver = Object.assign(Object.assign({}, toggleButtonStyle), { backgroundColor: '#1c82c6', border: '1px solid #FFF', color: SharedStyle.COLORS.white });
export default class FooterToggleButton extends Component {
    ...
    render() {
        return (<div style={this.state.over || this.state.active ? toggleButtonStyleOver : toggleButtonStyle} onMouseOver={e => this.toggleOver(e)} onMouseOut={e => this.toggleOut(e)} onClick={e => this.toggle(e)} title={this.props.title}>
        {this.props.text}
      </div>);
    }
}
