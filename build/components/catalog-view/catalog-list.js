...
const historyContainer = Object.assign(Object.assign({}, searchContainer), { padding: '0.2em 0.625em' });
...
export default class CatalogList extends Component {
    ...
    render() {
        ...
        let selectedHistoryElements = selectedHistory.map((el, ind) => <div key={ind} style={historyElementStyle} title={el.name} onClick={() => this.select(el)}>{el.name}</div>);
        return (<ContentContainer width={this.props.width} height={this.props.height} style={Object.assign(Object.assign({}, containerStyle), this.props.style)}>
