...
export default class RulerX extends Component {
    ...
    render() {
        ...
        let positiveRulerContainer = Object.assign(Object.assign({}, rulerContainer), { width: (this.props.positiveUnitsNumber * elementW), left: this.props.zeroLeftPosition });
        let negativeRulerContainer = Object.assign(Object.assign({}, rulerContainer), { width: (this.props.negativeUnitsNumber * elementW), left: this.props.zeroLeftPosition - (this.props.negativeUnitsNumber * elementW) });
        let positiveDomElements = [];
        if (elementW <= 200) {
            for (let x = 0; x < this.props.positiveUnitsNumber; x++) {
                positiveDomElements.push(<div key={x} style={Object.assign(Object.assign({}, elementStyle), { gridColumn: (x + 1), gridRow: 1 })}>
            {elementW > 30 ? (x * 100) : ''}
          </div>);
            }
        }
