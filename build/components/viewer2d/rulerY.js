...
export default class RulerY extends Component {
    ...
    render() {
        ...
        let positiveRulerContainer = Object.assign(Object.assign({}, rulerContainer), { top: this.props.zeroTopPosition - (this.props.positiveUnitsNumber * elementH), height: (this.props.positiveUnitsNumber * elementH) });
        let negativeRulerContainer = Object.assign(Object.assign({}, rulerContainer), { top: this.props.zeroTopPosition + (this.props.negativeUnitsNumber * elementH), height: (this.props.negativeUnitsNumber * elementH) });
        let positiveDomElements = [];
        if (elementH <= 200) {
            for (let x = 1; x <= this.props.positiveUnitsNumber; x++) {
                positiveDomElements.push(<div key={x} style={Object.assign(Object.assign({}, elementStyle), { gridColumn: 1, gridRow: x })}>
