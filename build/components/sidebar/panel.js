...
export default class Panel extends Component {
    ...
    render() {
        ...
        <h3 style={Object.assign(Object.assign({}, STYLE_TITLE), { color: hover ? SharedStyle.SECONDARY_COLOR.main : SharedStyle.PRIMARY_COLOR.text_alt })} onMouseEnter={() => this.toggleHover()} onMouseLeave={() => this.toggleHover()} onClick={() => this.toggleOpen()}>
          {name}
          {headComponents}
          {opened ?
        ...
        <div style={Object.assign(Object.assign({}, STYLE_CONTENT), { display: opened ? 'block' : 'none' })}>
          {children}
        </div>
      </div>);
    }
