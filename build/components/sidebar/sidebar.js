...
export default function Sidebar({ state, width, height, sidebarComponents }) {
    ...
    let multiselected = selected.lines.size > 1 ||
    ...
    return (<aside style={Object.assign({ width, height }, STYLE)} onKeyDown={event => event.stopPropagation()} onKeyUp={event => event.stopPropagation()} className="sidebar">
