...
export default class PanelGuides extends Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        return (this.state.addHGVisible !== nextState.addHGVisible ||
    ...
    render() {
        ...
        return (<Panel name={translator.t('Guides')}>
        <Tabs id='guidesTabs' style={tabStyle}>
          ...
          <TabPanel>
            ...
            return (<tr key={hgKey}>
                ...
                {this.state.addHGVisible ? (<tr>
                    <td colSpan='3' style={addGuideStyle} onClick={e => this.setState({ addHGVisible: false })}>
                      {translator.t('+ Add Horizontal Giude')}
                    </td>
                  </tr>) : (<tr>
                    <td colSpan='2'>
                      <FormNumberInput value={0} onChange={e => {
            projectActions.addHorizontalGuide(e.target.value);
            return this.setState({ addHGVisible: true });
        }} min={0} max={this.props.state.getIn(['scene', 'height'])}/>
                    </td>
                    <td>
                      <FaTimes style={iconStyle} onClick={e => this.setState({ addHGVisible: true })}/>
                    </td>
                  </tr>)}
              </tbody>
            </table>
          ...
          <TabPanel>
            ...
            return (<tr key={hgKey}>
                ...
                {this.state.addVGVisible ? (<tr>
                    <td colSpan='3' style={addGuideStyle} onClick={e => this.setState({ addVGVisible: false })}>
            ...
            return this.setState({ addVGVisible: true });
                    ...
                    <td>
                      <FaTimes style={iconStyle} onClick={e => this.setState({ addVGVisible: true })}/>
                    </td>
                  </tr>)}
              </tbody>
            </table>
